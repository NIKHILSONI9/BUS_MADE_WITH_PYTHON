...
label_text = "221B183(INDRANIL SAMANTA)"
...
#name of student
name_student= Label(root,text="Student Name : INDRANIL SAMANTA",fg="blue",font=('Poppins',15),pady=30)
name_student.pack()
#enrollment no.
enroll= Label(root,text="Enrollment No. : 221B183 ",fg="RED",pady=30,font=('Poppins',15))
enroll.pack()



#mobile number
mobile= Label(root,text="Mobile No. : 9407080822 ",fg="blue",pady=30,font=('Poppins',15))
mobile.pack()

#teacher name
teacher= Label(root,text="Submitted To : Dr. Mahesh Kumar ",bg="light green",fg="red",pady=10,font=('Poppins',15))
teacher.pack()
